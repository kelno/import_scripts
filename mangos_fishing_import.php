...
$output_filename = "fishing_mangos.sql";
...
// STEP 1 - Deleting all our fishing holes
fwrite($file, "-- STEP 1 - Deleting our stuff" . PHP_EOL);

$query = "SELECT g.guid
FROM ${sunWorld}.gameobject g
JOIN ${sunWorld}.gameobject_template gt ON gt.entry = g.id
WHERE gt.type = 25";
...
JOIN ${cmangosWorld}.gameobject_template gt ON gt.entry = g.id
WHERE gt.type = 25";
$stmt = $conn->query($query);
$stmt->setFetchMode(PDO::FETCH_ASSOC);
